...
export function tinhTienTK(lop, giaVatLieu) {
    ...
    let tongtien = tienCongPhut * 2 + ((lop.length == 0) ? 0 : (lop.length - 1)) * tienCongPhut;
...
export function tinhTienIn(lop, giaVatLieu) {
    ...
    for (let i = 0; i < lop.length; i++) {
        ...
        else if (maxLength <= 400) tienin = ((maxLength / 25) * tienCongPhut * heSo / 3) + (tienCongPhut * heSo);
        else tienin = ((maxLength / 25) * tienCongPhut * heSo / 3.5) + (tienCongPhut * heSo);
...
export function tinhTienCat(lop, giaVatLieu) {
    ...
    for (let i = 0; i < lop.length; i++) {
        ...
        else if (maxLength <= 400) tienin = ((maxLength / 25) * tienCongPhut * heSoNhan / 3) + (tienCongPhut * heSoNhan);
        else tienin = ((maxLength / 25) * tienCongPhut * heSoNhan / 4) + (tienCongPhut * heSoNhan);
