...
export function tinhCanNang(lop, giaVatLieu, thongSoTong, giaPhuKien) {
    console.log((+thongSoTong.canVl));
    console.log((+ thongSoTong.canHop));
    console.log((+thongSoTong.canVl +(+ thongSoTong.canHop)));
    if ((+thongSoTong.canVl + thongSoTong.canHop) > 0) return (+thongSoTong.canVl +(+ thongSoTong.canHop));
